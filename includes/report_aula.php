...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        ON c.id_profesor = p.id INNER JOIN aulas a ON c.id_aula = a.id WHERE c.id_aula = '$id_aula'";
        ...
        $this->SetY(55);
        $this->SetX(12.5);
        $this->Cell(60, 4, 'Aula: ' . utf8_decode($filas['aula']), 0, 1, 'L');
        ...
        $this->Cell(65, 10, 'Observaciones', 1, 1, 'C', 0);
    }
...
while ($row = $resultado->fetch_assoc()) {
    ...
    $pdf->Cell(20, 10, utf8_decode($row['fecha']), 1, 0, 'L', 0);
    ...
    $pdf->Cell(65, 10, utf8_decode($row['observacion']), 1, 1, 'L', 0);
}
