    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h3 class="modal-title" id="exampleModalLabel">Agregar nuevo cargo</h3>
            ...
            <div class="modal-body">
                ...
                <form id="addForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" min="0" id="monto" name="monto" class="form-control" required>
                    </div>


                    <br>

                    <input type="hidden" name="accion" value="insert_cargo">
